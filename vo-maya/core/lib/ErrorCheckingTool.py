...
try:
    ...
    try:
        ...
        print "PySide and PyQt4 not found"
if default == "none":
...
class ErrorCheckingTool(Ui_MainWindow, Ui_BaseClass):
    ...
    def createListWidget(self, inPutList,  title):
        ...
        if inPutList == []:
            ...
            self.CurrentItem.setBackground(0, QBrush(QColor("green")))
            self.CurrentItem.setForeground(0, QBrush(QColor("green")))
        else:
            self.CurrentItem.setBackground(0, QBrush(QColor("red")))
...
def StartUI():    
    ...
    MayaWindowPtr     = shiboken.wrapInstance(long(OpenMayaUI.MQtUtil.mainWindow()), QMainWindow)
